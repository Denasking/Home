...
export default function PrivacySecurityScreen() {
  const navigation = useNavigation<any>(); // FIXED: Added type any
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.card}>
          ...
          {/* FIXED: Properly structured TouchableOpacity with closing tags */}
          <TouchableOpacity 
            style={styles.menuItem} 
            onPress={() => navigation.navigate("DataPrivacy")}
          >
            <View style={styles.menuItemLeft}>
              <Ionicons name="eye" size={22} color="#003366" />
              <View>
                <Text style={styles.menuItemTitle}>Data Privacy Settings</Text>
                <Text style={styles.menuItemDescription}>Control how your data is used</Text>
              </View>
            </View>
          ...
          >
            <View style={styles.menuItemLeft}>
              <Ionicons name="lock-closed" size={22} color="#003366" />
              <View>
                <Text style={styles.menuItemTitle}>Account Security</Text>
                <Text style={styles.menuItemDescription}>Manage your account security settings</Text>
              </View>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#ccc" />
          </TouchableOpacity>
          ...
          >
            <View style={styles.menuItemLeft}>
              <Ionicons name="document-text" size={22} color="#003366" />
              <View>
                <Text style={styles.menuItemTitle}>Privacy Policy</Text>
                <Text style={styles.menuItemDescription}>Read our privacy policy</Text>
              </View>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#ccc" />
          </TouchableOpacity>
